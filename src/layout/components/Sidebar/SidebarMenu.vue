<template>
  <ul class="sidebar__menu">
    ...
    <li class="icon-mailshake">
      <a href="https://app.brightestminds.io/mailstats/">Mailstats</a>
    </li>
    <li class="icon-timetracker">
      <a href="https://app.brightestminds.io/timetracker/">Timetracker</a>
    </li>
    <li class="icon-timestats">
